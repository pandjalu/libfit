...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="info-box mb-3 bg-danger">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Buku yang di download</span>
        ...
        <div class="info-box mb-3 bg-warning">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Buku yang di pinjam</span>
        ...
        <div class="info-box mb-3 bg-info">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Buku yang belum di kembalikan</span>
